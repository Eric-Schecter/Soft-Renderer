...
void Application::initScene() {
	auto sphere1 = std::make_shared<Sphere>(glm::vec3(-.5f, 0.25f, 0.f), 0.25f, std::make_shared<Dielectrics>(1.5f));
	auto sphere2 = std::make_shared<Sphere>(glm::vec3(0.f, 0.25f, 0.f), 0.25f, std::make_shared<Lambertian>(glm::vec3(.7f, .3f, .3f)));
	auto sphere3 = std::make_shared<Sphere>(glm::vec3(0.5f, 0.25f, 0.f), 0.25f, std::make_shared<Metal>(glm::vec3(1.f),0.1f));
	auto land = std::make_shared<Sphere>(glm::vec3(0.f,-100.f,0.f), 100.f, std::make_shared<Lambertian>(glm::vec3(1.f,1.f,0.f)));
