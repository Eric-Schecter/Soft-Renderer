...
private:
	...
	std::vector<vk::Buffer> uniformBuffersDirectionalLight;
	std::vector<vk::DeviceMemory> uniformBuffersMemoryDirectionalLight;
	std::vector<void*> uniformBuffersMappedDirectionalLight; // uniform handle

	std::vector<vk::Buffer> uniformBuffersAmbientLight;
	std::vector<vk::DeviceMemory> uniformBuffersMemoryAmbientLight;
	std::vector<void*> uniformBuffersMappedAmbientLight; // uniform handle

	std::vector<vk::Buffer> uniformBuffersSpotLight;
	std::vector<vk::DeviceMemory> uniformBuffersMemorySpotLight;
	std::vector<void*> uniformBuffersMappedSpotLight; // uniform handle

	std::vector<vk::Buffer> uniformBuffersPointLight;
	std::vector<vk::DeviceMemory> uniformBuffersMemoryPointLight;
	std::vector<void*> uniformBuffersMappedPointLight; // uniform handle

	std::vector<vk::Buffer> uniformBuffersCameraPos;
	std::vector<vk::DeviceMemory> uniformBuffersMemoryCameraPos;
	std::vector<void*> uniformBuffersMappedCameraPos; // uniform handle

	std::vector<vk::Buffer> uniformBuffersMaterial;
	std::vector<vk::DeviceMemory> uniformBuffersMemoryMaterial;
	std::vector<void*> uniformBuffersMappedMaterial; // uniform handle
